...
# 1.
"""
# to activate virtual env on VSC cmd
...
C:\PWBproject\ImageAnnotator\.venv\Scripts>activate.bat
(.venv) C:\PWBproject\ImageAnnotator\.venv\Scripts>
"""
# ----------------------------------------
# 2.
# check / change flask app -file location if needed
# check / change launch.json -file location if needed
# ----------------------------------------
# 3.
# on Windows VSC cmd and Python:
# set FLASK_APP=imageAnnoAPI
# ----------------------------------------
# run by command - flask run
# OR 
# run by command - python -m flask run
# ----------------------------------------
